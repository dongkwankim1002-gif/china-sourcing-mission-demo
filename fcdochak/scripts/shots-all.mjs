...
const groups = [
  ...
  { login: 'partner', paths: ['/partner', '/partner/inbox', '/partner/inbox>/partner/inbox/', '/partner/rates', '/partner/rates>/partner/rates/', '/partner/rates/new', '/partner/rates/upload', '/partner/shipments', '/partner/shipments>/partner/shipments/', '/partner/invoices', '/partner/market', '/partner/profile', '/partner/notifications', '/partner/reviews'] },
  ...
  { login: 'admin', paths: ['/admin', '/admin/queues', '/admin/data', '/admin/grades', '/admin/ads', '/admin/commission', '/admin/related', '/admin/settings', '/admin/audit', '/admin/demo', '/styleguide', '/admin/metrics', '/admin/assure', '/admin/research'] },
];
let bad = 0;
