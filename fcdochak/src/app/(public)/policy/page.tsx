      ...
      <div className="mt-8 grid gap-8">
        ...
        <S id="privacy" title="개인정보">
          <ul>
            ...
            <li>청구서 점검(/check)은 이용 흐름(방문·입력·점검·보관)을 세려고 브라우저에 무작위 기기 번호를 하나 만들어 두고, 서버에는 그 번호를 바꾼 값(해시)만 남깁니다. IP 주소·청구서 내용은 남기지 않습니다. 브라우저 저장소를 지우면 번호도 사라집니다.</li>
          </ul>
        </S>
        ...
        <S id="ranking" title="추천 순서">
          <p>추천 점수 = 정시 입고 30 · 청구 편차 25 · FC 회송률 25 · 가격 확실성 20. 모두 선적·청구 기록에서 계산합니다.</p>
          <ul>
