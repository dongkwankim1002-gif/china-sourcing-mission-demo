...
export function queryPublicReviews(q: Queryable, opts: { limit: number; partnerId?: string | null; today: string }): Promise<PublicReview[]> {
  return q.query<PublicReview>(
    ...
    [opts.limit, opts.partnerId ?? null, opts.today],
  );
}
