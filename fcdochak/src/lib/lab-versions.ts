 ...
 * Vercel 가지 주소 fcdochak-v3.vercel.app 를 붙이고 여기에 한 줄.
...
const DEFAULT: LabVersion[] = [
  ...
  { key: 'v2', name: 'v2', url: 'https://fcdochak-v2.vercel.app', note: '확정·책임 플랫폼 전환판 · 임시 DB(예시 자료)' },
  { key: 'v3', name: 'v3', url: 'https://fcdochak-v3.vercel.app', note: '다음 판 자리', planned: true },
];
